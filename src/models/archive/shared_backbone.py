...
SHARED_BACKBONE_CONFIG = {
    'losses': {
        'classification_output': 'categorical_crossentropy', #classification_loss, # 'categorical_crossentropy',
        'means_output': 'mae', # custom_means_loss,
        'cov_output': 'mae', # custom_cov_loss,
        'crit_output': 'mae'
    },
    'loss_weights': {
    ...
    'metrics': {
        ...
        'means_output': 'mae', # custom_mae,
        'cov_output': 'mae', # custom_mae,
        'crit_output': 'mae'
    },
    'is_multi_task': True,
