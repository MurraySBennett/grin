# grin — agent entry point

GRIN manuscript and GRT identifiability analysis
...
1. `CHAT_STATE.md` — the live state. **This alone is usually enough.**
...
There is exactly one live state file for this repo: `CHAT_STATE.md`.
